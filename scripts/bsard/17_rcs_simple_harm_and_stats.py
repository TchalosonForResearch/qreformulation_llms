"""Evaluate harm and significance for the exploratory BSARD RCS runs."""
...
RCS_RUNS = [
    {
        "method": "rcs_deepseek_test",
        "generator": "deepseek",
        "fusion_type": "rcs_original_plus_all_deepseek",
        "run_path": RUNS_DIR / "rcs_deepseek_test.tsv",
    },
    {
        "method": "rcs_gpt_test",
        "generator": "gpt",
        "fusion_type": "rcs_original_plus_all_gpt",
        "run_path": RUNS_DIR / "rcs_gpt_test.tsv",
    },
    {
        "method": "rcs_all_generators_test",
        "generator": "deepseek+gpt",
        "fusion_type": "rcs_original_plus_all_generators",
        "run_path": RUNS_DIR / "rcs_all_generators_test.tsv",
    },
]
...
def main() -> None:
    ...
    for rcs in RCS_RUNS:
        method = rcs["method"]
        generator = rcs["generator"]
        fusion_type = rcs["fusion_type"]
        run_path = rcs["run_path"]

        print("\n" + "=" * 80)
        print(f"Evaluating RCS: {method}")
            ...
            paper_rows.append(
                {
                    ...
                    "rcs_score": round(mean_candidate, 6),
    ...
    fusion_order = {
        "rcs_original_plus_all_deepseek": 1,
        "rcs_original_plus_all_gpt": 2,
        "rcs_original_plus_all_generators": 3,
    }
    ...
    gains_path = TABLE_DIR / "rcs_simple_per_query_all.csv"
    harm_path = TABLE_DIR / "rcs_simple_harm_rate.csv"
    stats_path = TABLE_DIR / "rcs_simple_stats.csv"
    paper_path = TABLE_DIR / "rcs_simple_summary_for_paper.csv"
    ...
    print("\n" + "=" * 80)
    print("RCS simple summary for paper:")
    print(paper_df.to_string(index=False))

    print("\n" + "=" * 80)
    print("RCS simple statistical summary:")
    display_cols = [
        "generator",
        "fusion_type",
        "metric",
